...
const CalendarTopBar = ({ selectedYear, selectedMonth, onMonthChange }) => {
  ...
  return (
    <div style={styles.topBar}>
      ...
      <div style={styles.icons}>
        <span style={styles.icon} onClick={() => navigate("/timelineview")}>
          <MdOutlineViewWeek size="30" color="#56c8d8" />
        </span>
